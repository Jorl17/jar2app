...
**jar2app** is a Python2/Python3 script that can easily convert any *jar* file into a *Mac OS X app* file. It seeks **simplicity**, and in fact can be run just like
